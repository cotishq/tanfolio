  ...
  return (
    <Container className="py-12">
      <div className="flex justify-center">
        <div
          className={`relative max-w-4xl w-full px-8 py-8 border border-border rounded-2xl bg-muted/20 dark:bg-muted/10 backdrop-blur-sm shadow-sm hover:shadow-md transition-all duration-500 ease-out transform ${
